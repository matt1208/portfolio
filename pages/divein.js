        ...
        <div className={styles.container}>
            ...
            <div className={styles.main} style={cssProperties}>
                ...
                <p className={styles.text}>
                    Check you some pictures of Dive In! Dive In was live online from 2019-2021, but you can check out pictures of some of the pages and key features here.
                </p>

                <br></br>

                <div className={styles.grid}>
                    <img src="divein-1.png" height="400px" className={styles.imagecard}></img>
                    <img src="divein-2.png" height="400px" className={styles.imagecard}></img>
                    <img src="divein-3.png" height="400px" className={styles.imagecard}></img>
                </div>
                <br></br>
